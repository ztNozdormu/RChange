...
use crate::binance::api::{API, Futures};
use crate::binance::model::Empty;
use crate::binance::account::OrderSide;
use crate::binance::futures::model::{Order, TradeHistory};
...
impl FuturesAccount {
    ...
    ) -> Result<Vec<crate::binance::futures::model::Income>> {
        let mut parameters: BTreeMap<String, String> = BTreeMap::new();
