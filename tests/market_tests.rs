use rchange::binance::api::*;
use rchange::common::config::*;
use rchange::binance::market::*;
use rchange::binance::model::*;
...
mod tests {
    ...
    fn get_all_prices() {
        ...
        match prices {
            rchange::binance::model::Prices::AllPrices(symbols) => {
    ...
    fn get_all_book_tickers() {
        ...
        match book_tickers {
            rchange::binance::model::BookTickers::AllBookTickers(tickers) => {
    ...
    fn get_klines() {
        ...
        match klines {
            rchange::binance::model::KlineSummaries::AllKlineSummaries(klines) => {
